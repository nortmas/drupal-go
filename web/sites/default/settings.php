 ...
 * @endcode
 */
$settings['hash_salt'] = 'TkoNEuJGS8EG2LtoObWli77Xq9GIKvbrKws6CbTCuIRar97sOxYDs_QlBkI06WXaNrobUpGaig';
...
if (file_exists($app_root . '/sites/default/settings.docker.php')) {
	include $app_root . '/sites/default/settings.docker.php';
}
$databases['default']['default'] = array (
  'database' => 'drupal',
  'username' => 'drupal',
